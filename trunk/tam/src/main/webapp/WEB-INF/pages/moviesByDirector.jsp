...
<c:forEach var="md" items="${moviesByDirector}">
	...
	<br/>
	REGISTA: ${md.director.name} ${md.director.surname}
	<br/>
...
<c:if test="${isLast != true}">
	<a href="#" onclick="getMoviesByDirectorPage('${page+1}', '${id}')">next</a>
</c:if>

<br/>
numero pagina: ${page}
<c:if test="${page - 1 != 0}">
	<a href="#" onclick="getMoviesByDirectorPage('${page-1}', '${id}')">prev</a>	
</c:if>
<br/>
